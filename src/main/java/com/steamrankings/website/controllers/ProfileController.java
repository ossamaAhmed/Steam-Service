...
import com.steamrankings.website.SteamrollerApi;
...
public class ProfileController {
    ...
    public Map<String, String> getSteamNameFromId(String id) throws Exception {
        // Replace XXXXX with the Steam API key found on OneDrive in ECSE 428
        // Project\API examples\apikey.txt
        ...
        // Now we just search for the variable "personaname" that contains the
